...
public class ObservationBloodPressureLoincCodeAugments {
    ...
    private static final Optional<DatamartObservation.CodeableConcept> NEW_BLOOD_PRESSURE_LOINC =
            Optional.of(DatamartObservation.CodeableConcept.builder()
                    .coding(Optional.of(DatamartCoding.builder()
    ...
    static DatamartObservation replaceBloodPressureLoincCode(Augmentation.Context<DatamartObservation> ctx) {
